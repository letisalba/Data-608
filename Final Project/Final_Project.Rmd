...
```{r, fig.height=12, fig.width=14, echo=FALSE, warning=FALSE}
p4 <- pcos_data %>% 
...
```{r, echo=FALSE, warning=FALSE, fig.height=12, fig.width=14}
p13 <- pcos_data %>% 
...
#   tabPanel("Yes or No"),
#            mainPanel(fluidRow(
#              column(1,  plotlyOutput("plot1")),
#              column(2, plotlyOutput("plot2"))
#       ),
#   tabPanel("Table")
# 
# )
