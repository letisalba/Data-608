...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(PCOS), fill = PCOS)) +
    geom_bar(show.legend = FALSE) + 
    geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
    scale_x_discrete(labels=c('No', 'Yes')) +
    labs(title="Barplot",
          x ="PCOS(Yes or No)", y = "count") +
   theme_ipsum() +
      theme(
        plot.title = element_text(size=10)
      )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Pregnant), fill = Pregnant)) +
    geom_bar(show.legend = FALSE) + 
    geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot",
        x ="Pregnant(Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Weight_gain), fill = Weight_gain)) +
    geom_bar(show.legend = FALSE) + 
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot", 
        x ="Weight Gain (Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(hair_growth), fill = hair_growth)) +
    geom_bar(show.legend = FALSE) + 
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot",
        x ="Hair Growth(Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Skin_darkening), fill = Skin_darkening)) +
    geom_bar(show.legend = FALSE) + 
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot",
        x ="Skin Darkening (Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Hair_loss), fill = Hair_loss)) +
    geom_bar(show.legend = FALSE) + 
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot",
        x ="Hair Loss(Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Pimples), fill = Pimples)) +
    geom_bar(show.legend = FALSE) + 
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot",
        x ="Pimples(Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Fast_food), fill = Fast_food)) +
    geom_bar(show.legend = FALSE) + 
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot",
        x ="Fast Food(Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Reg_Exercise), fill = Reg_Exercise)) +
    geom_bar(show.legend = FALSE) + 
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  scale_x_discrete(labels=c('No', 'Yes')) +
  labs(title="Barplot",
        x ="Regular Exercise(Yes or No)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=10)
    )
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(Blood_Group), fill = Blood_Group)) +
    geom_bar(show.legend = FALSE) +
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  labs(title="Barplot",
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(`Age(yrs)`), fill="#69b3a2")) +
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(`Weight(kg)`), fill="#69b3a2")) +
    geom_histogram(stat="count", show.legend = FALSE) +
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  labs(title="Barplot",
        x ="Weight(kg)", y = "count") +
...
```{r}
pcos_data %>% 
  ggplot(aes(x = as.factor(`Marriage_Status(yrs)`), fill="#69b3a2")) +
    geom_histogram(stat="count", show.legend = FALSE) +
  geom_text(aes(label = ..count..), stat = "count", vjust = 1.5, colour = "white") +
  labs(title="Barplot",
        x ="Married status(yrs)", y = "count") +
  theme_ipsum() +
    theme(
      plot.title = element_text(size=5)
    )
...
```{r}
pcos_data %>% 
ggplot(aes(x=`Age(yrs)`, y=`Cycle_length(days)`, color=PCOS)) + 
    geom_point() +
...
fluidPage(    
  ...
  titlePanel("PCOS in Indian Women"),
